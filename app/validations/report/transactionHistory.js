...
module.exports = {
  ...
  rules: {
    ...
    'sort.sortBy':
      'in:ID,TXN_SEQUENCE,CREATED_DATE,FROM_ID,TO_ID,BUYER_ID,AVAILABLE_DATE,TRAN_TYPE,TRAN_MEANING,FROM_NAME,TO_NAME,FROM_EMAIL,TO_EMAIL,STATUS,CURRENCY,AMOUNT',
  ...
  messages: {
    ...
    'sort.sortBy.in':
      "sortBy field must be one in 'ID,TXN_SEQUENCE,CREATED_DATE,FROM_ID,TO_ID,BUYER_ID,AVAILABLE_DATE,TRAN_TYPE,TRAN_MEANING,FROM_NAME,TO_NAME,FROM_EMAIL,TO_EMAIL,STATUS,CURRENCY,AMOUNT'.",
